...
## are used to make the regressions.

## Data used in this replication can be downloaded at: encurtador.com.br/lAPR0
## In this code I used some part of the code of rshowcase, available at: https://gist.github.com/rshowcase/cc30fac759195e0d014c
